...
Pieces of code that could be run outside of a loop are referred to as loop-invariant. If these pieces of code were not included in the loop, this would greatly speed up the program.
