...
Dead Expression Elimination is an optimization that intends to remove those expressions that do not modify the environment.
...
The unassigned `e ^ val` expression is a dead expression, and could be removed.
