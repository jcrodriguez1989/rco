...
If a variable is a known numerical value and the variable is used in later expressions, constant propagation decreases run-time by substituting the numerical value of the variable in the expression.
