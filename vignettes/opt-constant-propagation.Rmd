...
```x <- 3+27-10``` with the value of the operation of the constants ```x<-20```, it is known as constant propogation. Constant propogation acts as a means to reduce redundancies in your r program and increase its efficiency.
