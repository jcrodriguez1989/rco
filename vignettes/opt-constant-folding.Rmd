...
Constant folding is a code optimization technique that recognizes expressions that could already be computed instead of running the code to compute that value. This optimization is useful as the code does not have to compute for the value during runtime. 
