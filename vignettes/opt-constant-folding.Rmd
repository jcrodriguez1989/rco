...
Constant folding gets rid of unneeded calculations later on in the program, that always result in the same value. When the program's first compiled, it converts phrases like `320 * 200` to `64000`; this means that less time will be spent on this calculation later on.
