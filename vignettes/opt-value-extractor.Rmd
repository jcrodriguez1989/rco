...
vignette: >
  %\VignetteIndexEntry{Efficient Value Extraction}
...
The *opt_value_extractor* function of the *rco* achieves this by, parsing the given code snippet, detecting the usage of value extraction methods/techniques and replacing it with the most appropriate one, by singling out the row_number and column_number in all cases individually.title: "Untitled"
author: "Saxenism"
date: "06/03/2020"
