...
The removal of unnecessary code lines that are just lying around with a set of program codes can be defined as Dead Code Elimination. These code lines do not serve any purpose in the main set of programs. Removing these codes makes the program size less and simplified and allows in faster execution of program which saves the time in compilation of the program. This is also useful for faster analisation of programs  (checking for errors).
