...
Consider another example wherein you have to concatenate two strings:

For example, you have boolean statements as seen below.
...
This could could be simplified to:

```{r eval=FALSE}
cs2 <- (1 + 1 == 2) && (2 + 2 == 4) && (3 + 3 == 6)
c <-  cs_2 || 2
d <- !cs_2 
```
