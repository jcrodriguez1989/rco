...
a = tmp + g;
d = tmp * e;
In the above example , it is transformed if the cost of storing and fetching temp is less than b*c.
CSE analyzes the expression and considers whther it is useful to transform the expression.
